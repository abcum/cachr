...
// LIFO represents an in-memory Last In First Out cache.
type LIFO struct {
	size  int
	bytes int
	queue *list.List
...
func (c *LIFO) Has(key string) bool {
...
// returned.
func (c *LIFO) Get(key string) []byte {
...
func (c *LIFO) Del(key string) []byte {
...
// size of the cache will rise above the allowed cache size, the newest
// items will be removed.
func (c *LIFO) Put(key string, val []byte) {
